...
trait CordovaFirebaseAnalyticsProvider extends AnalyticsProvider {
  ...
  object CordovaFirebaseAnalytics extends Analytics {
    ...
    override def logLevelUpEvent(level: Long, customs: (String, AnalyticsValue)*): Unit = {
      js.Dynamic.global.cordova.plugins.firebase.analytics.logEvent("level_up", withCustoms(customs)(js.Dictionary("level" -> level.toDouble)))
    }

    override def logLevelEndEvent(levelName: String, success: Boolean, customs: (String, AnalyticsValue)*): Unit = {
      js.Dynamic.global.cordova.plugins.firebase.analytics.logEvent("level_end", withCustoms(customs)(js.Dictionary("level_name" -> levelName, "success" -> (if(success) 1 else 0))))
    }
    override def logLevelStartEvent(levelName: String, customs: (String, AnalyticsValue)*): Unit = {
      js.Dynamic.global.cordova.plugins.firebase.analytics.logEvent("level_start", withCustoms(customs)(js.Dictionary("level_name" -> levelName)))
    }
    ...
    override def logShareEvent(itemId: Option[String], customs: (String, AnalyticsValue)*): Unit = {
      ...
      js.Dynamic.global.cordova.plugins.firebase.analytics.logEvent("share", params)
    }
    ...
    override def logBeginTutorialEvent(tutorialId: String, levelName: Option[String], customs: (String, AnalyticsValue)*): Unit = {
      ...
      js.Dynamic.global.cordova.plugins.firebase.analytics.logEvent("tutorial_begin", params)
    }
    override def logCompleteTutorialEvent(tutorialId: String, levelName: Option[String], customs: (String, AnalyticsValue)*): Unit = {
      val params = withCustoms(customs)()
      if(tutorialId.nonEmpty) params("tutorial_id") = tutorialId
      levelName.foreach(params("level_name") = _)
      js.Dynamic.global.cordova.plugins.firebase.analytics.logEvent("tutorial_complete", params)
    }

    override def logUnlockAchievementEvent(achievementId: String, customs: (String, AnalyticsValue)*): Unit = {
      js.Dynamic.global.cordova.plugins.firebase.analytics.logEvent("unlock_achievement", withCustoms(customs)(js.Dictionary("achievement_id" -> achievementId)))
    }
    ...
    override def logPurchaseEvent(transactionId: Option[String], value: Double, currency: String, itemId: Option[String], customs: (String, AnalyticsValue)*): Unit = {
      ...
      js.Dynamic.global.cordova.plugins.firebase.analytics.logEvent("purchase", params)
    }
    ...
    override def setGameScreen(gameScreen: String): Unit = {
      js.Dynamic.global.cordova.plugins.firebase.analytics.setCurrentScreen(gameScreen)
    }
