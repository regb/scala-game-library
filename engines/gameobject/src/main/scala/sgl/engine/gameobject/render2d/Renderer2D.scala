...
final case class ClearColor2D(red: Float, green: Float, blue: Float, alpha: Float)
object ClearColor2D {
  given ContextKey[ClearColor2D] = ContextKey[ClearColor2D]("sgl.engine.gameobject.render2d.ClearColor2D")
}
